 ...
 * @LastEditTime: 2021-03-25 14:21:42
...
import { DatetimePicker, Swipe, SwipeItem, Tab, Tabs } from "vant";
...
app.use(DatetimePicker).use(Swipe).use(SwipeItem).use(Tab).use(Tabs);
